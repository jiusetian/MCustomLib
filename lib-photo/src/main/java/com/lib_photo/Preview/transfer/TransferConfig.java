...
public final class TransferConfig {
    ...
    private List<ImageView> originImageList; //原来的显示图片的imageview的集合
    ...
    public void setExView(ExView exView){
        this.exView=exView;
    }

    public ExView getExView(){
        return exView;
    }
    ...
    public static class Builder {
        ...
        private AbsListView listView;
        private RecyclerView recyclerView;
        private ExView exView; //额外添加的view
         ...
         * @return
         */
        public Builder setExView(ExView exView){
            this.exView=exView;
            return this;
        }
